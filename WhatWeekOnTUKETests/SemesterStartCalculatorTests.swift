...
final class SemesterStartCalculatorTests: XCTestCase {
    ...
    func testCalculateSemesterStart() {
        ...
        for testCase in testCases {
            ...
            do {
                let calculatedDate = try calculateSemesterStart(for: referenceDate)
                XCTAssertEqual(
    ...
    func testOutOfSemesterPeriods() {
        ...
        for testCase in testCases {
            ...
            XCTAssertThrowsError(
                try calculateSemesterStart(for: referenceDate),
    ...
    func testExamPeriodWithTestCases() {
        ...
        for testCase in testCases {
            let ref = isoStringToDate(testCase.input)
            do {
                _ = try calculateSemesterStart(for: ref)
    ...
    func testSummerBreak() {
        ...
        XCTAssertThrowsError(try calculateSemesterStart(for: ref)) { error in
    ...
    func testValidSummerSemester() {
        ...
        do {
            let result = try calculateSemesterStart(for: ref)
